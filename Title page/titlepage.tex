...
\begin{titlepage}
    ...
    \begin{center}
        ...
        %
        {\singlespacing\huge{\textbf{Implementation and Characterization of an Optical Dipole Trap for Cold Atoms in Proximity of a Hollow-Core Fiber}}\par}
    \end{center}
    ...
    \begin{minipage}[t]{0.47\textwidth}
        ...
        \vspace{2mm}\\
        \textcolor{red} {Prof. Marco Prevedelli} \\\\}}
    \end{minipage}
    %
    \hfill
    %
    \begin{minipage}[L]{0.35\textwidth} \textcolor{black}{
        ...
        \vspace{2mm}\\
        \noindent{Francesco Nasoni}}}
        }
    \end{minipage}
    %
    \cfoot[C]{
        \\
        \bf Graduation Session July 2026\\
        \vspace{3mm}
