...
\begin{enumerate}
    ...
    \begin{equation*}
        \bar{I}\text{on} = \langle I_\text{on} \rangle \qquad \bar{I}\text{off} = \langle I_\text{off} \rangle\,.
    \end{equation*}
    ...
    \begin{enumerate}[label=\roman*.]
        ...
        \begin{equation}
            A_{i}^{\text{out}} = \int_{\text{outside}} \left( P_{i}(x) - \bar{I}_{i}(x) \right) dx \qquad i \in \{\text{on, off}\}
        \end{equation}
