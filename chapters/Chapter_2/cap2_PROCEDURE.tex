...
The molasses is performed with a detuning different from that used for the MOT phase, it is changed with a ramp of 20 steps with a total duration of 5~ms. The ramp stars 50~$\mu$s after the shim coils are changed to their molasses value. 
...
\begin{enumerate}
    ...
    \item The averaged images are converted into one dimensional density profiles by integrating along the columns. This further increase the signal-to-noise ration.
